...
class Enemy {
    ...
    update() {
        ...
        this.move_d = true
        let objects = qt.query(this.range, [])
        if (objects != null) {
        ...
        objects = qtEnemies.query(this.range, [])
        if (objects != null) {
            for (let p of objects) {
